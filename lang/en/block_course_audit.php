...
$string['othersource'] = 'Other source';
$string['othertarget'] = 'Other target';
$string['firstinstance'] = 'First';
$string['lastinstance'] = 'Last';
...
$string['show'] = 'Show';
$string['hintmessage'] = 'Hint Message';
$string['showmessage'] = 'Show Message';
$string['actiontype'] = 'Action Type';
$string['changesetting'] = 'Change Setting';
$string['addcontent'] = 'Add Content';
$string['addcontenttype'] = 'Add Content Type';
$string['settingorcontent'] = 'Setting / Content to Add';
$string['newsettingvalue'] = 'New Value';
$string['choose'] = 'Choose...';
$string['addsection'] = 'Add Section';
$string['addassignment'] = 'Add Assignment';
$string['addquiz'] = 'Add Quiz';
$string['addforum'] = 'Add Forum';
$string['addwiki'] = 'Add Wiki';
$string['addfolder'] = 'Add Folder';
$string['addurl'] = 'Add URL';
$string['addpage'] = 'Add Page';
$string['addbook'] = 'Add Book';
$string['addmultichoice'] = 'Add Multiple Choice Question';
$string['addtruefalse'] = 'Add True/False Question';
$string['addessay'] = 'Add Essay Question';
$string['addshortanswer'] = 'Add Short Answer Question';
$string['addnumerical'] = 'Add Numerical Question';
$string['addmatching'] = 'Add Matching Question';
$string['addcloze'] = 'Add Cloze Question';
